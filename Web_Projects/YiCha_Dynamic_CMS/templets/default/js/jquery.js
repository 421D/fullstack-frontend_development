...
!function(a, b) {
    ...
    var s = function(a) {
        ...
        , L = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", N = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", O = N.replace("w", "w#"), P = "\\[" + M + "*(" + N + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + O + "))|)" + M + "*\\]", Q = ":(" + N + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + P + ")*)|.*)\\)|)", R = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), S = new RegExp("^" + M + "*," + M + "*"), T = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), U = new RegExp("=" + M + "*([^\\]'\"]*?)" + M + "*\\]","g"), V = new RegExp(Q), W = new RegExp("^" + O + "$"), X = {
            ...
            var d = "0x" + b - 65536;
            return d !== d || c ? b : 0 > d ? String.fromCharticleode(d + 65536) : String.fromCharticleode(d >> 10 | 55296, 1023 & d | 56320)
        };
        try {
    ...
    m.event = {
        ...
        fixHooks: {},
        keyHooks: {
            props: "char charticleode key keyCode".split(" "),
            filter: function(a, b) {
                return null == a.which && (a.which = null != b.charticleode ? b.charticleode : b.keyCode),
                a
            }
        },
        mouseHooks: {
    ...
    !function() {
        ...
        c = d && d.style) {
            ...
            k.clearticleloneStyle = "content-box" === b.style.backgroundClip,
    ...
    m.extend({
        ...
        style: function(a, b, c, d) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                k.clearticleloneStyle || "" !== c || 0 !== b.indexOf("background") || (i[b] = "inherit"),
