...
define('UC_DBPW', '');
define('UC_DBNAME', 'tea');
define('UC_DBCHARSET', 'gbk');
define('UC_DBTABLEPRE', '`tea`.cdb_uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', 'g1J3Xd0ewbmfYcE1K2a2fcr8s1S8GdmfubKfseH9r4s6jei1B1Ja514f42PeV4g2');
define('UC_API', 'http://localhost/tea/bbs/uc_server');
